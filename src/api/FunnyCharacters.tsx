...
export const useFunnyCharacter = () => {
    ...
    const [funnyCharacterResponse, setFunnyCharacterResponse] = useState<any>(null);


    const funnyCharacterRequest = async (prompt: string, characterName: string) => {
        setError(null);
        setSuccess(false);
        setLoading(true);
    ...
    return { funnyCharacterRequest, error, success, loading, funnyCharacterResponse };
}