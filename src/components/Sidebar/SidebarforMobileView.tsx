    ...
    >
      ...
      {user && (
        <div className="p-[0.5rem] border-t border-[#808080]/10 z-50">
          <div
            onClick={() => setIsPopupOpen((prev: any) => !prev)}
            className="p-[0.3rem] flex items-center gap-2 hover:bg-[#efefef] rounded-lg transition-colors duration-300"
          >
