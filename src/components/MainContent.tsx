...
const MainContent = ({ setOpenSidebar, openSidebar, roastData, loading, handleSubmit, onSubmit, register, handleInputChange, floatingSendButton }: any) => {
    return (
        <>
            {/* Header */}
            <Header setOpenSidebar={setOpenSidebar} openSidebar={openSidebar} />
            {/* Main Page */}
            <div className={`max-w-[48rem] mx-auto h-full flex flex-col flex-1 px-4 sm:px-8 transition-all duration-300`}>
                {/* Response Section  */}
