...
const HomePage = () => {
  ...
  return (
    <div className="w-full flex relative flex-row">
      ...
      <SidebarforMobileView setOpenSidebar={setOpenSidebar} setSelectedOption={setSelectedOption} selectedOption={selectedOption} openSidebar={openSidebar} user={user} />
