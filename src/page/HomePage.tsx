  ...
  return (
    <div className="w-full flex relative flex-row">
      {openSidebar ? (
        ...
        <div
          className={`sticky cursor-pointer text-sm inset-y-0 left-0 hidden w-[16.25rem] h-screen md:flex flex-col justify-between z-50 bg-[#f9f9f9] border-r border-[#808080]/10 ${openSidebar ? 'translate-x-0' : '-translate-x-100'} transition-all duration-300 ease-in-out`}
        >
          {/* Sidebar Icons */}
          <div className="flex items-center justify-between p-[1rem] border-b border-[#808080]/10">
            ...
            <div
              ...
              className="pr-[1rem] hover:cursor-ew-resize"
            >
              <SidebarIcon />
            </div>
          </div>
          ...
          {user && (
            <div
              ...
              className="p-[0.5rem] relative border-t border-[#808080]/10 z-50"
            >
              ...
              {isPopupOpen && (
                <div
                  ...
                  className="absolute bottom-18 inset-x-2 p-3 bg-[#fff] rounded-lg shadow-md border-[#cecece] border-[0.1px] text-md"
                >
        ...
        <div className="sticky cursor-pointer text-sm inset-y-0 left-0 hidden md:flex items-center flex-col h-screen bg-[#fff] w-[3.25rem] border-r border-[#808080]/10 transition-all duration-300 ease-in-out">
          <div className="w-full min-h-screen flex flex-col items-center">
            ...
            <div
              onClick={() => setOpenSidebar(!openSidebar)}
              className="text-[18px] p-[1rem] cursor-pointer"
            >
              😂
            </div>
            {/* Feature Section */}
              ...
              {user && (
                ...
                >
                  ...
                  {isPopupOpen && (
                    <div
                      onClick={(e) => e.stopPropagation()}
                      className="absolute bottom-full mb-2 inset-x-0 p-3 bg-[#fff] h-fit w-fit rounded-lg shadow-md border-[#cecece] border-[0.1px] text-md"
                    >
                      <p className="text-sm text-gray-400 hover:text-gray-900">
                        {user.email}
                      </p>
      ...
      {/* Main Content Area */}
      <div
        className={`flex-1 flex relative flex-col overflow-y-auto min-h-screen`}
      >
        ...
        {selectedOption === 'FunnyCharacters' && (
          <FunnyCharactersPage
            ...
            register={register}
            floatingSendButton={floatingSendButton}
            setFloatingSendButton={setFloatingSendButton}
          />
        )}
